...
class ExocomsAuthSignupHome(AuthSignupHome):
    ...
    def _signup_with_values(self, token, values, *args, **kwargs):
        # Invitation émise depuis le back-office : comportement natif.
        if token:
        ...
        # Inscription déjà déposée mais jamais activée : on relance l'email.
        ...
        if pending:
            ...
            # CORRECTION : On retourne le login au lieu de True pour satisfaire l'appelant
            return login
