...
class SinistreIntervenant(models.Model):
    """
    Artisan / Intervenant rattaché à la plateforme.
    Peut être serrurier, plombier, menuisier, etc.
    """
...
class SinistreSpecialite(models.Model):
    """Tag de spécialité pour les intervenants."""
