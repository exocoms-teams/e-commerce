...
""",
    ...
    'depends': [
        'website',
        'website_sale',
        'website_sale_whishlist',  # NB: this is Odoo's actual technical module
                                    # name (historic typo kept for compatibility
                                    # in Odoo core itself) — replaces the
                                    # decorative localStorage wishlist heart.
    ],
    'data': [
