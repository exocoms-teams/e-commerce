...
class MandatWizard(models.TransientModel):
    ...
    def default_get(self, fields_list):
        ...
        if so_id:
            ...
            res.update({
                ...
                'service_chorus':          so.service_chorus or p.chorus_service_code or '',
    ...
    def _send_bca_email(self, so):
        try:
            report = self.env.ref('mandat_administratif.action_report_bca')
            pdf_content, _ = report._render_qweb_pdf('mandat_administratif.report_bca', [so.id])
