...
# URL de base de la Merchant API (production / bac a sable).
API_BASE_URL_LIVE = 'https://merchant.revolut.com/api/'
API_BASE_URL_SANDBOX = 'https://sandbox-merchant.revolut.com/api/'
