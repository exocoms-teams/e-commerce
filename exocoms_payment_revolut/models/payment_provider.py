...
class PaymentProvider(models.Model):
    ...
    revolut_secret_key = fields.Char(
        ...
        help="Clé secrète de la Merchant API (sk_...). Utilisez la clé Sandbox lorsque le "
             "fournisseur est en mode test.",
    ...
    def _build_request_url(self, endpoint, **kwargs):
        ...
        base_url = const.API_BASE_URLS.get(self.state, const.API_BASE_URLS['test'])
