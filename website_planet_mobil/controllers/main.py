...
class WebsitePlanetMobil(http.Controller):
    ...
    def homepage(self, **kwargs):
        ...
        if not top_ventes:
            top_ventes = [
                {'id': 1, 'name': 'iPhone 15 Pro Max', 'description': "Le smartphone le plus puissant d'Apple avec...", 'price': 1299, 'rating': 5, 'image_url': '/website_planet_mobil/static/src/img/iphone15.jpg', 'badge': False},
                {'id': 2, 'name': 'Samsung Galaxy S21 Ultra', 'description': 'Le flagship Android ultime avec S Pen intégré', 'price': 1199, 'rating': 5, 'image_url': '/website_planet_mobil/static/src/img/samsung_s21.jpg', 'badge': False},
                {'id': 3, 'name': 'Apple Watch Series 9', 'description': 'Montre connectÃ©e avec écran toujours actif et...', 'price': 449, 'rating': 5, 'image_url': '/website_planet_mobil/static/src/img/apple_watch.jpg', 'badge': False},
                {'id': 4, 'name': 'Samsung Galaxy Watch 6', 'description': 'Suivi santé avancé et autonomie...', 'price': 399, 'rating': 4, 'image_url': '/website_planet_mobil/static/src/img/samsung_watch.jpg', 'badge': False},
            ]

        if not nouveautes:
            nouveautes = [
                {'id': 5, 'name': 'Google Pixel 8 Pro', 'description': 'Intelligence artificielle au service de la...', 'price': 999, 'rating': 5, 'image_url': '/website_planet_mobil/static/src/img/pixel8.jpg', 'badge': 'Nouveau'},
                {'id': 6, 'name': 'OnePlus 12', 'description': 'Performance flagship à prix accessible', 'price': 899, 'rating': 4, 'image_url': '/website_planet_mobil/static/src/img/oneplus12.jpg', 'badge': 'Nouveau'},
                {'id': 7, 'name': 'Sony WH-1000XM5', 'description': 'Casque à réduction de bruit active premium', 'price': 379, 'rating': 5, 'image_url': '/website_planet_mobil/static/src/img/sony_wh.jpg', 'badge': 'Nouveau'},
                {'id': 8, 'name': 'LG OLED C3 55"', 'description': 'TV OLED 4K 120Hz pour gaming et cinéma', 'price': 1599, 'rating': 5, 'image_url': '/website_planet_mobil/static/src/img/lg_oled.jpg', 'badge': 'Nouveau'},
            ]
