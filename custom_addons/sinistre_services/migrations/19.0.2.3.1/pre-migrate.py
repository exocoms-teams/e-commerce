# -*- coding: utf-8 -*-
"""
Migration 2.3.1 — PRE-migrate
Garantit le schéma planning/absences avant validation des vues.
"""
import logging
...
def migrate(cr, version):
    _logger.info("[sinistre 2.3.1] pre-migrate START (version=%s)", version)
    ...
    for col, col_type in new_cols:
        ...
        if not cr.fetchone():
            ...
            _logger.info("[sinistre 2.3.1] colonne %s ajoutée", col)
    ...
    if not cr.fetchone():
        ...
        """)
        _logger.info("[sinistre 2.3.1] table sinistre_intervenant_absence créée")

    _logger.info("[sinistre 2.3.1] pre-migrate END")
