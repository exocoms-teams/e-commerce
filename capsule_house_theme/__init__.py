...
DEVIS_SUR_MESURE_DATA = {
    ...
    # Étape 1 : Choix de la gamme & format
    'step_gammes': [
    ...
    # Étape 2 : Spécifications du terrain & Accès (Crucial pour la livraison/grutage des pods)
    'terrain_specs': [
        {
            'id': 'acces_camion',
    ...
    # Étape 3 : Options techniques & Raccordements
    'options_techniques': [
        {
    ...
    # Étape 4 : Usage & Informations projet
    'usages_projet': [
