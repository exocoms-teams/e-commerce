    ...
    'fr_FR': [
        ...
        },
        {
            ...
            'products': [
                ...
                {
                    'name': 'Réseau privé d\'entreprise',
        ...
        },
        {
            ...
            'products': [
                {
                    'name': 'Détection et anticipation',
                ...
                {
                    'name': 'Protection messagerie pro',
    ...
    'en_US': [
        ...
        },
        {
            ...
            'products': [
                ...
                {
                    'name': 'Private Enterprise Network',
        ...
        },
        {
            ...
            'products': [
                {
                    'name': 'Cloud IaaS Infrastructure',
        ...
        },
        {
            ...
            'products': [
                {
                    'name': 'Threat Detection & Anticipation',
